  ...
  return (
    <div className="min-h-screen bg-slate-50 relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-orange-100 rounded-full blur-[120px] opacity-60"></div>
                 ...
                 {cards.map((card, idx) => (
                     ...
                     >
                        ...
                        <div className="flex gap-6">
                            <span className="flex-shrink-0 w-12 h-12 bg-orange-50 text-orange-600 rounded-2xl flex items-center justify-center font-black text-xl">
                                {idx + 1}
                            </span>
                     ...
                     {top3[0] && (
                         ...
                         >
                            ...
                            <div className="mb-4 text-center">
                                 ...
                                 <p className="font-black text-orange-600 text-2xl">{Math.round(top3[0].score)} PTS</p>
                            </div>
                              ...
                              <div className="flex-1">
                                  <div className="flex justify-between items-center mb-2">
                                      ...
                                      <div className="flex items-center gap-2">
                                          ...
                                          <span className="font-black text-orange-600 text-2xl">{Math.round(r.score)}</span>
                                      </div>
                                  </div>
